...
private:
  static const string memberDefaultValue;
  static const string careCardDefaultValue;
  ...
  // Description: Sets a patient's care card number
  // Postcondition: Defaults to "0000000000" if the supplied number is invalid
  void setCareCard(string aCareCard);
...
public:
  ...
  // Postcondition: If aCareCard does not have 10 digits, then care card is set to "0000000000".
  //                All other data members set to "To be entered".
  Patient(string aName, string anAddress, string phone, string email, string aCareCard);
