...
private:
  ...
  // Description: Recursively delete nodes from a binary tree
  void destructR(BSTNode<ElementType> *current);

  // Description: Recursively copy nodes from a binary tree
  void copyR(BSTNode<ElementType> *source, BSTNode<ElementType> *target);
